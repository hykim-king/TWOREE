...
<body>
    ...
    function getStars(score) {
        let starCount = Math.round(score / 2);
        let stars = '★'.repeat(starCount) + '☆'.repeat(5 - starCount);
        return stars;
    }

    const pageListObj = JSON.parse('<%= list %>'); // Assuming 'list' is a JSON string
    ...
    $.each(pageListObj, function(index, page) {
        ...
        ul.append($("<li class='score'></li>").html("별점 : " + getStars(page.score))); // Use .html() to handle HTML content
